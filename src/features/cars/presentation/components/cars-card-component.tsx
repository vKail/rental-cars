            ...
            {cars.map((car) => (
                <div className="flex flex-col ">
                    ...
                    <Image
                        ...
                        height={200}
                    />
                    <h1 className="flex mx-2"> <p className="font-medium pr-1">Marca:</p> {car.brand}</h1>
                    <h1 className="flex mx-2"> <p className="font-medium pr-1">Modelo:</p> {car.model}</h1>
                    <h1 className="flex mx-2"> <p className="font-medium pr-1">Año:</p> {car.year}</h1>
